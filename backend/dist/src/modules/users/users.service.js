    ...
    async verifyUserAccess(targetUserId, currentUserId, currentUserRole, tenantId) {
        ...
        if (currentUserRole === client_1.UserRole.RESIDENT) {
            if (targetUserId !== currentUserId) {
                throw new common_1.ForbiddenException('Solo puedes acceder a tu propia informaciÃ³n en este tenant');
            }
            return true;
        }
        if (currentUserRole === client_1.UserRole.MAINTENANCE) {
            if (targetUserId !== currentUserId) {
                throw new common_1.ForbiddenException('Solo puedes acceder a tu propia informaciÃ³n');
            }
            return true;
        }
