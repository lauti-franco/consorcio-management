...
@ApiTags('units')
@Controller('units')
@UseGuards(JwtAuthGuard, RolesGuard) // ← AGREGADO: RolesGuard
@ApiBearerAuth()
export class UnitsController {
  ...
  @ApiQuery({ name: 'propertyId', required: true, type: String, description: 'Property ID' }) // CAMBIADO: buildingId → propertyId
  findAll(
