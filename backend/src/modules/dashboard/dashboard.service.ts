// src/dashboard/dashboard.service.ts - VERSIÃ“N COMPLETAMENTE CORREGIDA
import { Injectable, NotFoundException, ForbiddenException } from '@nestjs/common';
import { PrismaService } from '../../shared/database/prisma.service';
import { UserRole } from '@prisma/client';

// Interfaces para tipado fuerte (las mismas que tenÃ­as)
...
// Interfaces auxiliares (las mismas que tenÃ­as)
...
export class DashboardService {
  ...
  /**
   * Obtiene dashboard segÃºn el rol del usuario
   */
  ...
  // ========== MÃ‰TODOS PRIVADOS PARA RESIDENTES ==========
  ...
  // ========== MÃ‰TODOS PRIVADOS PARA MANTENIMIENTO ==========
  ...
  // ========== MÃ‰TODOS PARA KPIs AVANZADOS (NUEVOS) ==========
  ...
  private async getAverageResolutionTime(tenantId: string): Promise<number> {
    ...
    return totalTime / resolvedTickets.length / (1000 * 60 * 60 * 24); // Convertir a dÃ­as
  }
